...
export const state = {
	...
	menu: [
		{id:1, title: 'Омлет с куриным филе', img: plate.src},
		{id:2, title: 'Омлет с говяжим филе', img: plate.src},
	],
	socials: [
		{id: 1, img: vk.src, color: vkBlack.src, title: 'VK', link: 'https://vk.com/fitboxsu'},
		{id: 2, img: instagram.src, color: instagramBlack.src, title: 'Instagram', link: 'https://www.instagram.com/fitbox.su/'},
		{id: 3, img: whatsapp.src, color: whatsappBlack.src, title: 'Whatsapp', link: 'https://wa.me/79370077712'},
		{id: 4, img: telegram.src, color: telegramBlack.src, title: 'Telegram', link: 'https://t.me/fitboxsu'},
	],
	programList: {
	...
	aboutPage: {
		ourFood: [
			{id: 1, img: ourFoodIcons.src, title: 'Улучшает работу мозга', text: 'Наше питание исключает вредный для организма вредное количество сахар и содержит все необходимые для грамотного функционирования мозга элементы: большое количество минералов, витаминов и полезных жиров.'},
			{id: 2, img: ourFoodIcons2.src, title: 'Запускает процесс восстановления клеток', text: 'Рационы обогащены белком, который отвечает за рост и развитие клеток.'},
			{id: 3, img: ourFoodIcons3.src, title: 'Заряжает энергией', text: 'За счёт «цикличности» питания организм активизирует внутренние запасы энергии, а сбалансированный состав блюд дарит вам силы и бодрость.'},
			{id: 4, img: ourFoodIcons4.src, title: 'Оптимизирует метаболизм', text: 'Сбалансированная, полезная и питательная еда способствует здоровому и активному обмену веществ.'},
			{id: 5, img: ourFoodIcons5.src, title: 'Способствует снижению веса', text: 'Качество и количество еды – основа здоровья и стройности человека, а увеличение перерывов между приёмами пищи может стать эффективным инструментом для снижения массы тела.'},
			{id: 6, img: ourFoodIcons6.src, title: 'Нормализует гормональный фон', text: 'Здоровые жиры и цельные продукты поддерживают баланс гормональной системы.'},
		]
	},
	delivery: [
